<?php
    ...
    if( mysqli_num_rows( checkDownloads ) == 0 ) {
        $createDownload = mysqli_query( $con, "CREATE TABLE " . TSA_DB_PREFIX . "downloads( id int NOT NULL AUTO_INCREMENT, PRIMARY KEY(id), post_id int(11), hash char(40), original_file_name varchar(255), size int(11), date date );" );
        if( !$createDownload ) {
            ?>
